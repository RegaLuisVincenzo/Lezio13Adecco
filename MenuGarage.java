...
import com.adecco.veicolo.Automobile;
import com.adecco.veicolo.Furgone;
import com.adecco.veicolo.MotoCicletta;

public class MenuGarage {
	
	
	private ClasseGarage boxAuto ;
	private Scanner key;
	
	public MenuGarage() {
		boxAuto  = new ClasseGarage();
		key = new Scanner(System.in);
	}
	
	public MenuGarage(int posti) {
		boxAuto = new ClasseGarage(posti);
		key = new Scanner(System.in);
	}
